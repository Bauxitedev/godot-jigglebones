...
func _physics_process(delta) -> void:
	...
	var bone_id_parent: int = skeleton.get_bone_parent(bone_id)
	...
	var new_pos_clamped: Vector3 = goal_pos + (global_transform.origin - goal_pos).normalized() # * rest_length # Always 1
